...
@section('CUSTOM_JS')
    ...
    <script type="text/javascript" src="{{ asset("assets/js/github.js") }}"></script>
@endsection
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-3">
      ...
      <select name="date-hunt" id="date-hunt" class="form-control repos-filter">
    ...
    <div class="col-md-3">
      <div class="form-group">
      <select name="language" id="language" class="form-control repos-filter">
